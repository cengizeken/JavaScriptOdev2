...
let ulDOM = document.getElementsByTagName("li"); //burda var olan bütün li elementlerini alıp ulDOM'e atadık böylece elimizde kaç madde yani li olduğunu öğrendik.


// MEVCUT LİSTEYİ SİLMEK İÇİN ÇARPI BUTONUNUN OLUŞTURULMASI
for (let i = 0; i < ulDOM.length; i++) {
  let closeButton = document.createElement("span"); //close icon'u span etiketi içerisinde olduğu için yeni bir span elemanı oluşturup ve closeButton değişkenine atadık.
  ...
  ulDOM[i].append(closeButton); // closeButton değişkenini ulDOM'in 0, 1, 2... indexlerine ekleyerek aslında for döngüsünü kullanarak var olan listeye çarpı butonunu ekledik. 
